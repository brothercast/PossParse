...
export async function regenerateGoals(user_input) {
  ...
  spinnerText.textContent = 'Speculating New Outcomes...';
  ...
  try {
    ...
    if (response.ok) {
      ...
      updateGoalCards(data, userInputCell); // Added this line to update goal cards
...
export function showLoadingSpinner() {
  ...
  spinner.classList.remove('d-none');
  spinnerText.textContent = 'Speculating Structured Solution...';
}