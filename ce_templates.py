  ...
  <div class="modal-dialog" role="document">  
    <div class="modal-content">  
      ...
      <div class="modal-footer">  
        ...
        <button type="button" class="btn btn-info analyze-ce" data-ce-id="{{ ce_data.id }}">Analyze</button>  
...
def generate_dynamic_modal(ce_type, ce_data=None):  
    ...
    modal_content = render_template_string(BASE_MODAL_TEMPLATE, ce_type=ce_type, node_info=node_info, form_fields=form_fields, ce_data=ce_data or {})  
